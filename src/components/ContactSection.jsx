  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "Agradeço pelo contato. Retornarei assim que possível.",
      });
          ...
          <div className="space-y-8">
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4 justify-center">
                <a
                  href="https://www.linkedin.com/in/kauanbastosmendes/"
                  target="_blank"
                >
                  <Linkedin />
                </a>
                <a
                  href="https://www.instagram.com/kkauan_bastos/"
                  target="_blank"
                >
                  <Instagram />
                </a>
